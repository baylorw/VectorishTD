...
func setup_waves():
	#waves.push_back(create_uniform_wave(2, "weak", 5, 1))
	#waves.push_back(create_uniform_wave(2, "weak", 10, 2))
	#waves.push_back(create_uniform_wave(2, "normal", 5, 3))
	#waves.push_back(create_uniform_wave(2, "normal", 10, 4))
	#var wave = create_uniform_wave(2, "fast", 10, 5)
